...
The above algorithms need to be tuned with hyperparameters. We can visualize how the MSE, PSNR, and SSIM vary while we change them to find the optimal. Results are shown in figure \ref{fig:msepsnrssim}.

\begin{figure}[h]
    \centering
    \includegraphics[width=.8\linewidth]{images/msecompar.png}
